...
# Socket para comunicarse con otro ordenador
HOST = 'localhost'
PORT = 1977
            ...
            try:
                ...
                for line in buffer.splitlines():
                    if "ABS_X" in line:
                        ...
                        local_steer = scale_axis(val, 'ABS_X')
                    elif "ABS_Y" in line:
                        ...
                        if abs(scaled) < 0.05:
                            scaled = 0.0
                        if scaled < 0:  
                            #Joystick arriba (negativo): acelerar
                            local_throttle = 0.5 * abs(scaled)
                        else:  
                            #Joystick abajo (positivo): frenar
                            local_throttle = 0.0
