...
#---------------------------------
#---Compara a nivel visual dos ficheros csv (inferencia y humano)
#---Como una carrera
#-------------------------------
...
def get_spawn_point(cam_index: int) -> carla.Transform:
    ...
    if cam_index == 14:
        return carla.Transform(carla.Location(x=-37.9, y=-28, z=0.5), carla.Rotation(yaw=0))
    raise ValueError("cam_index inválido (1..14)")
