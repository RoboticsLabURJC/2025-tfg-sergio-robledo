...
#---------------------------------
#---Evalua un modelo entrenado a nivel visual
#--Modo estela o modo mapa de calor
#-------------------------------


MODEL_PATH = "experiments/exp_weightedmse_1767448507/trained_models/pilot_net_model_best_123.pth"
...
def main():
    ...
    # Yaw de la cámara cenital para rotar el plano en ciertas pistas
    ...
    # ===== Heatmap con la (misma resolución que la cámara cenital =====
    ...
    try:
        while True:
            ...
            # Calcula velocidad (m/s) y escala y normaliza igual que en train (÷3.5 y clip 0..1)
            ...
            if camera_image["data"] is not None:
                ...
                if mode == "trail":
                    ...
                    # Oscurecer ligeramente la imagen base para resaltar el heatmap (cuando mas pequeño, mas oscuro)
                    dark_factor = 0.65
                    ...
                    # etiquetas (usamos el mismo VMAX_KMH que arriba)
