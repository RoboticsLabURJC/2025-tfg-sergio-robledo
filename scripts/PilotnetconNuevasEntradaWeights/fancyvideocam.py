...
MODEL_PATH = "experiments/exp_weights_estados_1768159488/trained_models/pilot_net_model_best_123.pth"
...
def _build_intrinsics(w, h, fov_deg_h):
    """FOV de CARLA. Calculamos fx, fy, cx, cy."""
...
def main():
    ...
    # Yaw de la cámara cenital para rotar el plano, dependiendo del track
    ...
    heat_gain = 2.0           # multiplica la intensidad
    ...
    try:
        while True:
            ...
            # Calcula velocidad (m/s) y la escala igual que la transformacion del entrenamiento
            ...
            # Concatenar al tensor de imagen
