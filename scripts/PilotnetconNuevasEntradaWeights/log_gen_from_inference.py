...
#---------------------------------
#---Genera un fichero .log y un csv con los datos de un
#--vehiculo en inferencia
#-------------------------------

log_filename = "/home/sergior/Downloads/pruebas/PilotnetconNuevasEntradaWeights/logs/inference_data/InferenceWeightsTrack014CC.log"
MODEL_PATH = "experiments/exp_weights_estados_1768067898/trained_models/pilot_net_model_best_123.pth"
EXP_DIR = "./"
LOGS_DIR = os.path.join(EXP_DIR, "logs/inference_data")
...
def main():
    ...
    if cam_index == 9:
        spawn_point = carla.Transform(carla.Location(x=-65, y=94.5, z=0.2), carla.Rotation(yaw=55-150))
    if cam_index == 10:
    ...
    if cam_index == 14:
        spawn_point = carla.Transform(carla.Location(x=-37.9, y=-28, z=0.5), carla.Rotation(yaw=0))
    ...
    try:
        while True:
            ...
            speed_norm = float(np.clip(speed_mps / 3.5, 0.0, 1.0))  # normalizacion identica a train
