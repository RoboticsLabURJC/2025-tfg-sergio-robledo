...
HOST = '127.0.0.1'
PORT = 2000
VEHICLE_MODEL = 'vehicle.deepracer04.aws_deepracer04'
...
spawn_point = carla.Transform(
    carla.Location(x=55.3, y=246.1, z=1.0),  # Ubicación exacta
    carla.Rotation(yaw=0)  # Orientación inicial
)
...
camera_transform = carla.Transform(carla.Location(x=0.5, z=1.0))  # Cámara en la parte delantera
