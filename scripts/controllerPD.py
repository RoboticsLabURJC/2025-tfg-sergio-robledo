...
integral_steer = 0.0
Kp_steer = 0.06    # menos agresivo
Ki_steer = 0.001   # se mantiene
Kd_steer = 0.25    # más suave la reacción a cambios rápidos
...
def process_image_front(image):
    ...
    # ROI: solo el tercio central horizontal
    third_w = width // 3
    ...
    if nonzero is not None:
        ...
        line_center_x = mean[0] + third_w  # ajustar por el offset de recorte
